      ...
      <Container>
        <Row className="mb-4 align-items-start">
          <Col md={4} className="d-flex flex-column align-items-start">
            <div className="d-flex align-items-center mb-2">
              ...
              />
              <span className="fw-bold" style={{ fontSize: 24, color: '#22C55E', letterSpacing: 1 }}>
                Valuation Tools
              </span>
            </div>
            <p className="text-light" style={{ opacity: 0.85, fontSize: 15 }}>
              Reliable financial data and valuation tools for better decision making.
            </p>
            <div className="mt-3">
              <SocialIcons />
            </div>
          ...
          <Col md={4}>
            <h5 className="fw-bold text-white mb-3" style={{ letterSpacing: 1 }}>
              Quick Links
            </h5>
            <NavList />
          </Col>
        ...
        <Row>
          <Col className="text-center border-top pt-4" style={{ borderColor: '#334155 !important', color: '#cbd5e1', fontSize: 15 }}>
            ...
            <span style={{ color: '#22C55E', fontWeight: 600 }}>Valuation Tools</span>. All rights reserved.
          </Col>
        </Row>
      </Container>
    </footer>
