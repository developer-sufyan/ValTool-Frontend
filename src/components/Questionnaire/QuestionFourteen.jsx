...
export default function QuestionFourteen() {
  ...
  const handleNext = (e) => {
    e.preventDefault();
    localStorage.setItem('question 13', funding);
    console.log('question 13:', funding);
    ...
    <Fragment>
      ...
      <div style={{
        ...
        <h2 style={{ fontWeight: 700, marginBottom: '0.7rem', fontSize: '2.5rem', textAlign: 'center' }}>
          Did the Target company recently conduct any round of funding?
        </h2>
        <div style={{ color: '#555', fontSize: '1rem', marginBottom: '1.5rem', textAlign: 'center', maxWidth: 400 }}>
          Please indicate if the target company has recently completed any funding round (e.g., seed, Series A, etc).
        </div>
